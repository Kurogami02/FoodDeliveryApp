...
public class DetailFoodFavoriteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_food_favorite);
    ...
    private void loadDetail() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    if (hintsArray.length() > 0) {
                        ...
                        for (int i = 0; i < measuresOject.length(); i++) {
                            try {
                                ...
                                Toast.makeText(DetailFoodFavoriteActivity.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                            }
                        }

                        detailFoodAdapter = new DetailFoodAdapter(DetailFoodFavoriteActivity.this,label2,weight2);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DetailFoodFavoriteActivity.this, "" + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    void confirm() {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                MyDatabaseHelper myDatabaseHelper = new MyDatabaseHelper(DetailFoodFavoriteActivity.this);
